...
def faceDetection(test_img):
    ...
    classloc = os.path.abspath('haarcascades')
    classloc = classloc + "/haarcascade_frontalface_default.xml"
    face_haar_cascade=cv2.CascadeClassifier(classloc)#Load haar classifier
